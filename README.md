...
- Main orchestrator instructions live in `plugins/myteam-plugin/0.4.0/skills/team/SKILL.md`.
- Skill, role, workflow, prompt, contract, dependency, and deployment versions live in `plugins/myteam-plugin/0.4.0/skills/team/version.json`.
- Workflow registry lives in `plugins/myteam-plugin/0.4.0/skills/team/references/workflows/registry.json`.
- Change history lives in `plugins/myteam-plugin/0.4.0/skills/team/changelog.md`.
- Role-specific guidance lives in `plugins/myteam-plugin/0.4.0/skills/team/references/agents/`.
- Workflow guidance lives in `plugins/myteam-plugin/0.4.0/skills/team/references/workflows/`.
- Input/output contracts live in `plugins/myteam-plugin/0.4.0/skills/team/contracts/`.
- Context compression and retry policies live in `plugins/myteam-plugin/0.4.0/skills/team/references/policies/`.
- Engineering benchmark principles live in `plugins/myteam-plugin/0.4.0/skills/team/references/principles/`.
- Evaluation prompts and scoring rules live in `plugins/myteam-plugin/0.4.0/skills/team/evals/`.
- Routing keywords live in `plugins/myteam-plugin/0.4.0/skills/team/references/routing.json`.
- Plugin registration metadata lives in `plugins/myteam-plugin/0.4.0/.codex-plugin/plugin.json`.
...
```text
C:\Users\{userName}\.codex\plugins\cache\personal-plugins\plugins\myteam-plugin\0.4.0
```
...
In `marketplace.json`, the plugin path should use `./plugins/myteam-plugin/0.4.0` relative to the cache root.
